#!/bin/bash
# Complete AllianceMine build process for RDS
set -e
...
# Stage 2: Extract Alliance Data
log "📥 Stage 2: Extracting Alliance data from FMS..."
...
if [ ! -f "./project_build" ]; then
    ...
    cp intermine-scripts/project_build /root/alliancemine/project_build
...
if command -v curl &> /dev/null && curl -s http://localhost:8080 > /dev/null; then
...
# Final Summary
log "============================================"
success "AllianceMine build completed successfully!"
log "============================================"
log "Summary:"
log "  - Database schema: ✅"
...
log ""
log "Next steps:"
log "  - Access mine at: http://localhost:8080/alliancemine"
